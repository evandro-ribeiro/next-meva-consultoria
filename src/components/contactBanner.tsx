...
export default function ContactBanner() {
  ...
  return (
    <section className="h-fit pb-16 md:h-screen md:p-12">
      <div className="flex flex-col justify-center pb-14 md:flex-row">
        ...
        >
          ...
          />
          <span className="absolute left-10 top-24 rounded-xl bg-orange-700 p-3 shadow-xl shadow-orange-500 hover:scale-105 hover:bg-amber-500">
      ...
      <div className="flex flex-col justify-center md:flex-row">
        ...
        >
          <video
            ...
            className="rounded-md"
          />
          <span className="absolute right-10 top-24 rounded-xl bg-amber-500 p-3 shadow-xl shadow-amber-700 hover:scale-105 hover:bg-amber-900">
